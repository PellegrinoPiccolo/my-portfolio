  ...
  return (
    <section className='w-full min-h-screen px-8 py-30 bg-background-secondary flex flex-col items-center' ref={contactRef} id="contact">
        ...
        <div className='flex flex-col md:flex-row gap-6 items-start w-full justify-center'>
            <motion.form onSubmit={handleSubmit} className='flex flex-col gap-4 w-full md:w-2xl' initial={{ opacity: 0, y: 10 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.4 }}>
            ...
            <div className='w-full md:w-xl flex flex-col items-center justify-center'>
                <motion.div className='w-full bg-background-primary border border-gray-800 rounded-lg p-6' initial={{ opacity: 0, y: 10 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.6 }}>
                ...
                <motion.div className='w-full bg-background-primary border border-gray-800 rounded-lg p-6 mt-6 flex flex-col gap-6' initial={{ opacity: 0, y: 10 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.8 }}>
                ...
                <motion.div className='w-full bg-linear-to-tr from-indigo-500/20 to-purple-500/20 border border-gray-700 rounded-lg p-6 mt-6 gap-2 flex flex-col' initial={{ opacity: 0, y: 10 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 1.0 }}>
