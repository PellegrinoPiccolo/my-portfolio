  ...
  return (
    <section id='hero' className='min-h-screen flex items-center justify-center relative overflow-hidden bg-linear-to-br from-gray-950 via-gray-900 to-gray-950'>
        ...
        <div className='relative z-10 text-center px-4'>
            ...
            <motion.button className='inline-block px-6 py-3 bg-indigo-600 text-white rounded-full hover:bg-indigo-700 transition cursor-pointer' initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.8 }}>View Projects</motion.button>
